...
const UserRequests = () => {
  ...
  const loggedInUserId = sessionStorage.getItem('user') ? JSON.parse(sessionStorage.getItem('user'))._id : null;
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      <h2 style={{ textAlign: 'center', marginBottom: '20px', color: '#333' }}>My Requests</h2>
      {requests.length === 0 ? (
